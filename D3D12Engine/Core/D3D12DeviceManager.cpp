...
void CD3D12DeviceManager::Initialize(HWND hWnd, UINT nWidth, UINT nHeight)
{
	InitializeDevice();
	InitializeFence();
	...
	InitializeSwapChain(hWnd, nWidth, nHeight);
...
void CD3D12DeviceManager::OnResize()
{
	assert(m_pD3dDevice);
	assert(m_pSwapChain);
...
void CD3D12DeviceManager::FlushCommandQueue()
{
...
D3D12_RESOURCE_BARRIER CD3D12DeviceManager::TransitionResourceFromPresentToRenderTarget()
{
	/*
...
void CD3D12DeviceManager::InitializeSwapChain(HWND hWnd, UINT nWidth, UINT nHeight)
{
	m_pSwapChain.Reset();
...
void CD3D12DeviceManager::CreateDepthStecilView(HWND hWnd, UINT nWidth, UINT nHeight)
{
